...
type TraderConfig struct {
	...
	// Bitget 配置
	BitgetAPIKey    string `json:"bitget_api_key,omitempty"`
	BitgetSecretKey string `json:"bitget_secret_key,omitempty"`
...
func (c *Config) Validate() error {
	...
	for i, trader := range c.Traders {
		...
		if trader.Exchange != "binance" && trader.Exchange != "hyperliquid" && trader.Exchange != "aster" && trader.Exchange != "bitget" {
